...
void tela_menu_principal(void) {
    ...
    printf("///            2. Módulo Bone                                               ///\n");
    printf("///            3. Módulo Tipo do Bone                                       ///\n");
    printf("///            4. Módulo Modelo                                             ///\n");
...
void tela_menu_aluno(void) {
    ...
    printf("///            = = = = = = = = = = = = = = = = = = = = = = = =              ///\n");
    printf("///                                                                         ///\n");
    printf("///            1. Cadastrar um novo bone                                    ///\n");
    printf("///            2. Pesquisar os dados de um bone                             ///\n");
    printf("///            3. Atualizar o cadastro de um bone                           ///\n");
    printf("///            4. Excluir um bone do sistema                                ///\n");
